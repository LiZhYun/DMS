...
from pathlib import Path
import torch
from configs.config_mujoco import get_config
...
def main(args):
    ...
    run_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                       0] + "/results") / all_args.env_name / all_args.scenario / all_args.algorithm_name / all_args.experiment_name / long_short_clip / str(all_args.seed)
