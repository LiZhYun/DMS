...
def get_config():
    ...
    parser.add_argument("--experiment_name", type=str, 
                        default="dms", help="an identifier to distinguish different experiment.")
    ...
    parser.add_argument("--n_training_threads", type=int,
                        default=32, help="Number of torch threads for training")
    parser.add_argument("--n_rollout_threads", type=int, 
                        default=40, help="Number of parallel envs for training rollouts")
    parser.add_argument("--n_eval_rollout_threads", type=int, 
                        default=5, help="Number of parallel envs for evaluating rollouts")
    ...
    parser.add_argument("--env_name", type=str, 
                        default='mujoco', help="specify the name of environment")
    ...
    parser.add_argument("--intention_hidden_size", type=int, 
                        default=64, help="Dimension of hidden layers for actor/critic networks") 
    ...
    parser.add_argument("--intention_size", type=int,                          
                        default=20, help="Dimension of intention for encoder/decoder networks") 
    parser.add_argument("--vae_lr", type=float,                          
                        default=2e-3, help='critic learning rate (default: 5e-4)')
    parser.add_argument("--intention_update_beta", type=float,                          
                        default=0.1, help=" soft update.")
    parser.add_argument("--use_intention", action='store_true',                         
                        default=False, help=" whether to use intention.")
    parser.add_argument("--causal_inference_or_attn", action='store_true',                         
                        default=False, help=" whether to use intention.")
    parser.add_argument("--long_short_coef", type=float,                         
                        default=1e11, help=" control threshold for KL value.")
    parser.add_argument("--long_short_clip", action='store_true',
                        default=False, help=" whether to use action clip.")
    parser.add_argument("--intention_clip", action='store_true',
                        default=False, help=" whether to use action clip.")
    parser.add_argument("--intention_update_freq", type=int, 
                        default=1, help='number of ppo epochs (default: 15)')
    parser.add_argument("--actor_update_freq", type=int, 
                        default=1, help='number of ppo epochs (default: 15)')
    parser.add_argument("--critic_update_freq", type=int, 
                        default=1, help='number of ppo epochs (default: 15)')  
    parser.add_argument("--long_short_clip_freq", type=int,                          
                        default=500, help='number of ppo epochs (default: 15)')  
    parser.add_argument("--preupdate", type=int, 
                        default=0, help='number of ppo epochs (default: 15)')  
    ...
    parser.add_argument("--critic_lr", type=float, 
                        default=1e-3, help='critic learning rate (default: 5e-4)')
    ...
    parser.add_argument("--ppo_epoch", type=int, 
                        default=5, help='number of ppo epochs (default: 15)')
    ...
    parser.add_argument("--num_mini_batch", type=int, 
                        default=40, help='number of batches for ppo (default: 1)')
    parser.add_argument("--entropy_coef", type=float, 
                        default=0.001, help='entropy term coefficient (default: 0.01)')
    ...
    parser.add_argument("--eval_episodes", type=int, 
                        default=5, help="number of episodes of a single evaluation.")
