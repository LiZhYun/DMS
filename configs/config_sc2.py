...
def get_config():
    ...
    parser.add_argument("--intention_size", type=int,                          
                        default=32, help="Dimension of intention for encoder/decoder networks") 
    ...
    parser.add_argument("--causal_inference_or_kl", action='store_true',                         
                        default=True, help=" whether to use intention.")
    parser.add_argument("--long_short_coef", type=float,                         
                        default=0.65, help=" control threshold for KL value.")
